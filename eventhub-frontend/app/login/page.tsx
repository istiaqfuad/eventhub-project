...
function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#0b0e14] text-white p-4">
      <div className="w-full max-w-md bg-[#151a23] rounded-2xl p-8 border border-white/10 shadow-xl">
        ...
        <div className="text-center mt-8 text-gray-400 text-sm">
          Don&apos;t have an account? <Link href="/register" className="text-[#00f0ff] hover:underline">Sign up</Link>
        </div>
      </div>
    </div>
  );
    ...
    <Suspense
      fallback={
        <div className="flex items-center justify-center min-h-screen bg-[#0b0e14] text-white">
          <div className="w-full max-w-md bg-[#151a23] rounded-2xl p-8 border border-white/10 text-center">Loading...</div>
        </div>
      }
    >
      <LoginForm />
